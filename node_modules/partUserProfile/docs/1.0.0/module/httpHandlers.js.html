 ...
 * @namespace node_modules/partUserProfile/lib/httpHandlers.js
 */
 ...
 * @memberOf nodemodule/partUserProfile/lib/httpHandlers
...
exports.getProfile = function (request, response) {
    ...
    /*    self._profile.getRealProfiles(request.data, [], &apos;intern_6&apos;, {
            &apos;request-id&apos;: uuid(),
            userIp: &apos;127.0.0.1&apos;
        }).then(function (res) {
            response.sendOk(res.data.real)
...
exports.editProfile = function (request, response) {
    ...
    /*    self._profile.editProfile(request.data, {&apos;request-id&apos;: uuid(), userIp: &apos;127.0.0.1&apos;})
            .then(function () {
                response.sendOk(&apos;&#x67E;&#x631;&#x648;&#x641;&#x627;&#x6CC;&#x644; &#x628;&#x627;&#x645;&#x648;&#x641;&#x642;&#x6CC;&#x62A; &#x648;&#x6CC;&#x631;&#x627;&#x6CC;&#x634; &#x634;&#x62F;.&apos;)
            })
            .fail(function (error) {
                response.sendFail(error.message)
            })*/
}
...
<nav>
    <h2><a href="index.html">Home</a></h2><h3>Namespaces</h3><ul><li><a href="node_modules_partUserProfile_lib_httpHandlers.js.html">js</a></li></ul>
</nav>

<br class="clear">

<footer>
    Documentation generated by <a href="https://github.com/jsdoc/jsdoc">JSDoc 3.6.4</a> on Sun May 03 2020 21:40:11 GMT+0430 (Iran Daylight Time)
</footer>
